                  ...
                  <div className='block'>
                    ...
                    {/* 3xs2:text-base sm1:text-base sm1:leading-relaxed sm2:text-lg */}
                      ...
                      <div className="flex items-center">
                        {/* sm1:my-1 */}
                        <div className="text-right 3xs1:w-3/4 3xs1:mx-1">
                        {/* 3xs2:w-2/3 3xs2:mx-1 3xs2:text-base
                        2xs1:w-3/5 2xs1:mx-1 
                        sm2:text-lg */}
                          Sólo para MX
                        </div>
                        <div className="3xs1:w-1/4 3xs1:mx-1">
                        {/* 2xs1:w-2/5 2xs1:mx-1 */}
                          <img title="iconMX" src={iconMX} alt="iconMX" placeholder="iconMX" className='3xs1:w-3'/>
                ...
                <div className='flex flex-row 3xs1:items-start md1:items-center lg:items-start justify-around h-full text-center'>
                  <div className='block'>
                    <div className='flex 3xs1:flex-col xl:flex-row justify-around'>
                      <div className='block bg-[#F12364] cursor-pointer rounded-[3.125rem] px-4 py-2 m-2 3xs1:w-32'>
                      {/* sm1:w-3/4 sm1:text-xl sm1:py-1 3xs3:my-2 */}
                        <span>Contrata</span>
                      </div>
                      <div className='block bg-[#603685] cursor-pointer rounded-[3.125rem] px-4 py-2 m-2 3xs1:w-32'>
                      {/* sm1:w-3/4 sm1:text-xl sm1:py-1 3xs3:my-2 */}
                        <span>Tu cuenta</span
                      ></div>
                    </div>
